      ...
      <div class="container my-3">
        <div class="row g-2 align-items-center">
          <div class="filter-bar d-flex align-items-center flex-wrap flex-lg-nowrap gap-2 mt-3">
            ...
            <select v-model="filters.district" class="form-select district" :disabled="!filters.city" @change="gotoFirstAndLoad">
            ...
            <div class="keyword input-group flex-nowrap">
              <input v-model.trim="filters.keyword" class="form-control" placeholder="關鍵字搜尋…" @keydown.enter.prevent="gotoFirstAndLoad" />
        ...
        <div class="d-flex justify-content-between align-items-center mt-4 flex-wrap">
          ...
          <div class="input-group" style="max-width:320px;">
            ...
            <input type="number" min="1" class="form-control" v-model.number="gotoPage" :class="{ 'is-invalid': gotoInvalid }" placeholder="頁碼" />
  ...
  .pet-card:hover { transform: translateY(-2px); box-shadow: 0 12px 24px rgba(0,0,0,.12); }
  .pet-card .card-img-top { width: 100%; height: 260px; object-fit: contain; background: #f0f0f0; padding: 8px; }
  ...
  /* 性別圖示 */
  .sex-icon { height: 18px; width: 18px; object-fit: contain; vertical-align: -3px; margin: 0 4px; background-color: #fff; border-radius: 50%; padding: 1px; border: 1px solid #ccc; }

  /* 置頂按鈕 */
  #backToTop { position: fixed; right: 24px; bottom: 24px; display: inline-flex; align-items: center; justify-content: center; width: 44px; height: 44px; border-radius: 50%; }
  </style>