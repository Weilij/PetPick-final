          ...
          <div class="row g-0 align-items-center">
              ...
              <div id="mission-carousel" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner" id="carouselImages" style="border-radius: 15px;">
                  <div v-for="(url, i) in images" :key="i" class="carousel-item"
                    ...
                    <img :src="srcOf(url)" class="d-block w-100" style="height:350px;object-fit:cover;"
                      @error="onImgError" alt="任務圖片" />
                  </div>
                </div>
                <div id="imageThumbnails" class="d-flex justify-content-center mb-4 mt-2 flex-wrap">
                  <img v-for="(url, i) in images" :key="'thumb' + i" :src="srcOf(url)" class="img-thumbnail mx-1"
                    :class="{ 'border-2 border-dark': i === currentIndex }"
                    style="height:80px;width:80px;object-fit:cover;cursor:pointer" @click="currentIndex = i"
                    @error="onImgError" alt="縮圖" />
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="card-body">
                ...
                <div class="mt-3">
                  <button id="btn-apply" class="btn" style="background-color: burlywood;" v-if="!isOwner"
                    :disabled="applying" @click="onApply">
                  ...
                  <button id="btn-favorite" class="btn" @click="onFav" :aria-pressed="isFavorited ? 'true' : 'false'"
        ...
        <div class="sticky-top" style="top: 90px;">
          ...
          <div class="card p-4 shadow-sm">
            <div class="d-flex align-items-center mb-2">
              <img :src="defaultavatar" id="posterAvatar" class="rounded-circle me-3" style="width: 68px; height: 68px;"
                alt="頭像" />
              <div>
